...
const About = () => {
    return (
        <section className="py-6 dark:bg-coolGray-800 dark:text-coolGray-100 h-full max-w-full bg-siteColors-backColor">
            <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10 h-screen">
                ...
                <div className="flex flex-row flex-wrap-reverse justify-center mt-12">
                    ...
                    <div className="flex flex-col justify-center w-full px-8 mx-6 my-12 text-center rounded-md md:w-96 lg:w-80 xl:w-64 dark:bg-coolGray-100 dark:text-coolGray-800">
                        ...
                        <div className="flex-1 my-4">
                            <p className="text-xl font-semibold leading-snug text-siteColors-purp">Butie</p>
